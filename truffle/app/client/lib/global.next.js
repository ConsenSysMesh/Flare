Meteor.startup(function() {
  ...
  jQuery.ajax({
    async:false,
    type:'GET',
    url: "http://hacknet.blockapps.net/static/js/api.js",
    success: initGlobals,
    dataType:'script',
  });

  function initGlobals(data, textStatus, jqxhr) {
    console.log("initializing globals");
    var Contract = require("Contract")
    var Solidity = require("Solidity")

    Meteor.globals.apiURL = "http://hacknet.blockapps.net"
    Meteor.globals.userAccount = Contract({"privkey":"1dd885a423f4e212740f116afa66d40aafdbb3a381079150371801871d9ea281"})
    ...
    var contractCode = Solidity(`
      ...
      contractCode.compile(Meteor.globals.apiURL, function() {
        console.log(contractCode.symtab)
        Meteor.globals.contract = Contract({address: "0x0c781397c72d50585539dd1405765d3fe71ce1c8", symtab: contractCode.symtab})
      })
    }
  })
